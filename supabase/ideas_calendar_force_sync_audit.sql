...
alter table public.calendar_items add column if not exists user_id uuid;
...
drop index if exists public.calendar_items_source_event_active_uidx;
...
where schemaname = 'public'
  and tablename in ('ideas', 'calendar_items')
