...
const csvPath = "C:/Users/karol/Downloads/Supabase Snippet List History Events in Sort Order.csv";
const outPath = "C:/great-org/greatorg/supabase/restore_history_events_from_csv.sql";
...
sql.push("-- Restore history_events from CSV.");
...
for (const [id, sortOrder, data] of rows) {
  ...
  sql.push("insert into public.history_events (id, sort_order, data)");
  sql.push(
