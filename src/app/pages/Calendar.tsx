...
export function CalendarPage() {
  ...
  const hasCurrentMonthViewsData = useMemo(() => hasMonthMetricRecords(dayViewsByDate, currentMonthKey), [currentMonthKey, dayViewsByDate]);
  const hasCurrentMonthReachData = useMemo(() => hasMonthMetricRecords(dayReachByDate, currentMonthKey), [currentMonthKey, dayReachByDate]);
  const useSharedMonthlyTotals = shouldUseMonthlyPerformanceSnapshot(monthlyPerformance, currentMonthKey, teamScope === "todos");
  const currentMonthViews = useSharedMonthlyTotals && !hasCurrentMonthViewsData ? monthlyPerformance.views : computedCurrentMonthViews;
  const currentMonthReach = useSharedMonthlyTotals && !hasCurrentMonthReachData ? monthlyPerformance.reach : computedCurrentMonthReach;
